...
type ChannelSearchOrdering = 'Most Popular' | 'Most Relevant' | 'Trending' | 'Most Subscribers' | 'Most Recently Created' | 'Most Recently Updated' | 'Most Videos' | 'Most Video Views';
...
declare const ChannelSearchOrderingMapping: Record<ChannelSearchOrdering, string>;
...
type ChannelSearchPeriod = 'daily' | 'weekly' | 'monthly' | 'alltime';
declare const ChannelSearchPeriodMapping: Record<ChannelSearchPeriod, string>;
...
declare class PornHub {
    route: {
        ...
        channelSearch(keyword: string, params: ChannelSearchOptions): string;
     ...
     */
    channel(urlOrName: string): Promise<ChannelPage>;
    /**
     * Get a random video.
     ...
     */
    searchChannel(keyword: string, options?: ChannelSearchOptions): Promise<{
