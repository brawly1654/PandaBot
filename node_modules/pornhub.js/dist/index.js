...
__export(index_exports, {
  ...
  ChannelSearchOrderingMapping: () => ChannelSearchOrderingMapping,
  ChannelSearchPeriodMapping: () => ChannelSearchPeriodMapping,
...
var ChannelSearchOrderingMapping = {
  "Most Popular": "rk",
  "Most Relevant": "al",
  "Trending": "tr",
...
var ChannelSearchPeriodMapping = {
  daily: "t",
  weekly: "w",
  monthly: "m",
  alltime: ""
...
var Route = {
   ...
   */
  channelSearch(keyword, params) {
    const {
      page = 1,
      order = "Most Relevant"
    } = params;
    return (0, import_urlcat.default)(BASE_URL, "/channels/search", {
...
function parsePornstarResult($, container) {
...
function parseByDom($, url) {
  ...
  const about = ((_a = aboutCandidate.get(0)) == null ? void 0 : _a.type) === "text" ? aboutCandidate.text() : null;
...
var numberMapper3 = (value) => parseReadableNumber(value);
var DefaultMapper2 = {
  key: defaultMapper2,
...
// src/scrapers/search/channel.ts
var import_urlcat4 = __toESM(require("urlcat"));
async function channelSearch(engine, keyword, options) {
...
function parseResult2($) {
  ...
  const result = $list.map((_, el) => {
    ...
    return {
      name,
      url: url ? (0, import_urlcat4.default)(BASE_URL, url) : "",
      ...
      rank,
      photo: getDataAttribute(photo, "thumb_url", "")
    };
  }).get();
  return result;
}
...
var import_urlcat6 = __toESM(require("urlcat"));
...
function parseResult4($) {
  ...
  const result = $list.map((_, el) => {
    ...
    return {
      ...
      url: (0, import_urlcat6.default)(BASE_URL, path2),
...
0 && (module.exports = {
  ...
  ChannelSearchOrderingMapping,
  ChannelSearchPeriodMapping,
  GifOrderingMapping,
  HttpStatusError,
  IllegalError,
  PornHub,
